...
exports.postData = async (req, res) => {
  try {
    ...
    let REQ = await SeqFunc.getOne( req.sequelizeDB.INV_TransferHeader,{ where: { TransNo: TransNo } } );
    ...
    if (REQ.success) {
      ...
      if (REQ.Data.TransType === 'XFR'){
        ...
        if (Consumption.Success){
          await Stock.Addition.Addition(req.sequelizeDB,req.sequelizeDB.INV_TransferDetail, TransNo, REQ.Data.DestinationLocationCode, REQ.Data.DestinationLocation, res)
        }
      }
